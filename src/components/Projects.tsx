    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projectsList.map((project, idx) => (
          ...
          >
            <div className="glass-card overflow-hidden bg-[#161617]/90 rounded-2xl border border-[#262627] shadow-xl flex flex-col justify-between h-full group">
              <div>
                ...
                <div className={`h-24 w-full bg-gradient-to-r ${project.bannerGradient} relative flex items-center justify-center`}>
                  ...
                  <div className="w-12 h-12 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center text-white border border-white/20 group-hover:scale-110 transition-transform duration-300 shadow-md">
                    <Rocket size={20} />
                  </div>
                </div>
